    ...
    <>
       <nav class="home" id='home'>
        ...
        <div class="child">
          ...
          <a href="https://drive.google.com/file/d/1JpZVbvroF4kbXZAn0PPsiaTMd8LgeJg-/view?usp=drive_link"><button type="button" class="btn block">Resume  <FontAwesomeIcon icon={faFileLines} /></button></a>
        </div>
